            ...
            <form action="{{ route('periode.update', $periode) }}" method="POST">
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="text" id="judul" name="judul" value="{{ old('judul', $periode->judul) }}" required
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="date" id="tanggal" name="tanggal" value="{{ old('tanggal', $periode->tanggal->format('Y-m-d')) }}" required
                                   class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
